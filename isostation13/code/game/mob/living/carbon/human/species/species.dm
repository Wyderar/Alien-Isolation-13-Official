...
/datum/species
	...
	var/forced_stand_icon_state = null
	var/forced_rest_icon_state = null
	var/forced_dead_icon_state = null
	var/uses_no_overlays = 0
...
/datum/species/proc/attack_hand_special(atomic)//return TRUE for an override of attack_hand(), otherwise normal shit happens
	return FALSE
...
/datum/species/proc/handle_vision(var/mob/living/carbon/human/H)
	...
	if(!H.druggy)
		H.see_in_dark = (((H.sight == SEE_TURFS|SEE_MOBS|SEE_OBJS) ? 8 : min(darksight + H.equipment_darkness_modifier, 8)) + darksight_addendum)
