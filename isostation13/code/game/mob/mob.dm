...
/mob/proc/alien_nested()
	return (buckled() && istype(buckled, /obj/structure/bed/nest))


/mob/proc/is_physically_disabled()
	return incapacitated(INCAPACITATION_DISABLED)

/mob/proc/is_upperbody_disabled()
	return incapacitated(INCAPACITATION_DISABLED|INCAPACITATION_RESTRAINED)

/mob/proc/incapacitated_any()
	return incapacitated(INCAPACITATION_DEFAULT|INCAPACITATION_DISABLED|INCAPACITATION_RESTRAINED|INCAPACITATION_BUCKLED_PARTIALLY|INCAPACITATION_BUCKLED_FULLY)
