/*
My shitty attempt at making airlocks easier to enter and exit without airflow bullshit - Cherkir
*/
...
//	if (is_exterior() && config.impenetrable_station_exterior) //removing this because it's impossible to
//check how it was opened and who opened it as of right now - Cherkir
	//	return
	if(!can_open(forced))
		return FALSE
...
/obj/machinery/door/airlock/New(var/newloc, var/obj/structure/door_assembly/assembly=null)
	...
	if (istype(src, /obj/machinery/door/airlock/external))
		locked = FALSE //ok so the retards at baystation decided that manually making every
		//external airlock locked map-wise was a good idea so I'm putting this here
